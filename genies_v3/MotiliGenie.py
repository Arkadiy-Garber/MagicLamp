...
def main():
    ...
    os.system("echo ${motility_hmms} > HMMlib.txt")
    ...
    if not have_lib(HMMrootdir):
        ...
        try:
            ...
            HMMrootdir = location + "/hmms/motility"
    ...
    if not have_lib(HMMrootdir):
        print("MotiliGenie could not locate its HMM library. Please run the setup.sh script if\n"
              ...
              "into your $PATH. Set the $motility_hmms environment variable to point at a directory\n"
