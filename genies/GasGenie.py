  ...
  \    )\.-.      /`-.     )\.--.     )\.-.    )\.---.   )\  )\  .'(   )\.---.  
    ...
    parser.add_argument('--makeplots', type=str,
                        help="include this flag if you would like GasGenie to make some figures from your data?. "
                             ...
                             "Please be sure to install all the required R packages as instrcuted in the GasGenie Wiki: "
                             "https://github.com/Arkadiy-Garber/GasGenie/wiki/Installation. "
...
# ****************************** FILTERING OUT LIKELY FALSE POSITIVES *************************************
    ...
    if args.makeplots:
        print("Running Rscript to generate plots. Do not be alarmed if you see Warning or Error messages from Rscript. "
              ...
              "If not, you can plot the data as you wish on your own, or start an issue on GasGenie's GitHub repository\n")
        # if conda == 0:
        #     Rdir = args.R
        # else:
